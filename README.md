...
## 프로젝트 소개
Meet Your Book은 전자책을 검색하고 소장 도서관을 찾을 수 있는 원스톱 도서 검색 사이트입니다.
...
## 🔗 Links
- [서비스 바로가기](https://www.meetyourbook.site/)
- [API 문서](https://api.meetyourbook.site/docs/index.html)
...
- Testing & Quality: <img src="https://img.shields.io/badge/Vitest-6E9F18?style=flat&logo=vitest&logoColor=white"/>, <img src="https://img.shields.io/badge/Testing Library-E33332?style=flat&logo=testinglibrary&logoColor=white"/>, <img src="https://img.shields.io/badge/MSW-FF0000?style=flat&logo=msi&logoColor=white"/>, <img src="https://img.shields.io/badge/ESLint-4B32C3?style=flat&logo=eslint&logoColor=white"/>
- Component Development: <img src="https://img.shields.io/badge/storybook-09B3AF?style=flat&logo=storybook&logoColor=white"/>

### Backend

## 코딩 컨벤션 및 개발 문서

- [프론트엔드 개발 문서](https://github.com/MeetYourBook/meet-your-book/wiki/%F0%9F%93%9A-%ED%94%84%EB%A1%A0%ED%8A%B8%EC%97%94%EB%93%9C-%EA%B0%9C%EB%B0%9C-%EB%AC%B8%EC%84%9C)

## 에러 개선
### Frontend
1. [무한스크롤 API요청이 여러번 되는 문제 해결기](https://seunghyunlim.vercel.app/posts/infinite-scroll)
2. [필터 컴포넌트 성능 문제와 최적화](https://seunghyunlim.vercel.app/posts/react-improving-filter)
3. [HTTP 상태코드에 따라 ErrorBoundary의 Fallback UI 구성하기](https://seunghyunlim.vercel.app/posts/errorboundary)
