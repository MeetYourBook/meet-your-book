...
class LibraryServiceTest {
    ...
    void findById() {
        ...
        //when
        LibraryResponse response = libraryService.findById(save.getId());
    ...
    void delete() {
        ...
        //when
        libraryService.delete(save.getId());
    ...
    void update() {
        ...
        Long id = save.getId();
        LibraryUpdateRequest updateRequest = new LibraryUpdateRequest("경기도서관", "공공도서관",
            "www.example.com");

        //when
        libraryService.updateLibrary(id, updateRequest);
